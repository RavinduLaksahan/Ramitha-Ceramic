...
const HomePage = () => {
  ...
  return (
    <div>
      ...
      <nav className="bg-black bg-opacity-30 shadow fixed w-full top-0 z-50 ">
        <div className="container mx-auto flex justify-between items-center py-8 " style={{ fontFamily: 'Rajdhani, sans-serif' }}>
          ...
          <ul className="flex font-bold space-x-20 mr-20 text-gray-500">
            <li><a href="#home" className={`hover:text-gray-200 ${location.hash === '#home' ? 'text-white' : ''}`}>HOME</a></li>
            <li><Link to="/products" className={`hover:text-gray-200 ${location.pathname === '/products' ? 'text-white' : ''}`}>PRODUCTS</Link></li>
            <li><a href="#about" className={`hover:text-gray-200 ${location.hash === '#about' ? 'text-white' : ''}`}>ABOUT US</a></li>
            <li><a href="#contact" className={`hover:text-gray-200 ${location.hash === '#contact' ? 'text-white' : ''}`}>CONTACT US</a></li>
          </ul>
        </div>
      </nav>
      ...
      <section id="about" className="h-screen flex items-center justify-center bg-white mt-6" style={{ fontFamily: 'Rajdhani, sans-serif' }}>
        ...
        <h2 className="text-5xl font-bold mb-6 relative overflow-hidden">
          ...
          <div className="flex flex-col md:flex-row space-y-6 md:space-y-0 md:space-x-6 justify-center bg-opacity-10">
            <div className="flex-1 w-96 h-64 p-6 bg-gradient-to-b from-red-300 to-gray-200 shadow-lg flex items-center justify-center rounded-lg hover:scale-105 transition duration-300">
              <p className="text-lg">Discover our exquisite range of ceramic tiles and fittings, crafted with passion and precision.</p>
            </div>
            <div className="flex-1 w-96 h-64 p-6 bg-gradient-to-b from-red-300 to-gray-200 shadow-lg flex items-center justify-center rounded-lg hover:scale-105 transition duration-300">
              <p className="text-lg">We blend traditional craftsmanship with modern design, offering sustainable and stylish solutions for every home.</p>
            </div>
            <div className="flex-1 w-96 h-64 p-6 bg-gradient-to-b from-red-300 to-gray-200 shadow-lg flex items-center justify-center rounded-lg hover:scale-105 transition duration-300">
              <p className="text-lg">Transform your spaces with our unique and beautiful ceramic collections. Experience the Ramitha Ceramics difference today!</p>
            </div>
          </div>
          {/* <div className="w-20 h-2 bg-black mt-8 mx-auto"></div> */}
        </div>
      </section>

      

      <section id="contact" className="h-screen flex items-center justify-center bg-white mt-4" style={{ fontFamily: 'Rajdhani, sans-serif' }}>
        <div className="max-w-6xl mx-auto text-center p-8" style={{ fontFamily: 'Rajdhani, sans-serif' }}>
          <h2 className="text-5xl font-bold mb-6 relative overflow-hidden">
          ...
          <div className="flex flex-col md:flex-row space-y-6 md:space-y-0 md:space-x-6 justify-center bg-opacity-10">
            <div className="flex-1 w-96 h-64 p-6 bg-gradient-to-b from-gray-600 to-gray-200 shadow-lg flex flex-col justify-center rounded-lg items-center hover:scale-105 transition duration-300">
              <h3 className="text-xl font-bold mb-4"><FaUserTie className="inline mr-2" /> Director</h3>
              <p>J.M. Ramitha Jayasundara</p>
              <p><GiRotaryPhone className="inline mr-2" /><a href="tel:+94763942353">076-394 2353</a></p>
              <p><IoMailSharp className="inline mr-2" /><a href="mailto:ramithaj18@gmail.com">ramithaj18@gmail.com</a></p>
            </div>
            <div className="flex-1 w-96 h-64 p-6 bg-gradient-to-b from-gray-600 to-gray-200 shadow-lg flex flex-col justify-center rounded-lg items-center hover:scale-105 transition duration-300">
              ...
              <p><GiRotaryPhone className="inline mr-2" /><a href="tel:+94812406835">Tel: 081-24 06 835</a></p>
              <p><MdOutlineFax className="inline mr-2" /><a href="tel:+94812406835">Fax: 081-24 06 835</a></p>
            </div>
            <div className="flex-1 w-96 h-64 p-6 bg-gradient-to-b from-gray-600 to-gray-200 shadow-lg flex flex-col justify-center rounded-lg items-center hover:scale-105 transition duration-300">
              ...
              <div className="flex justify-center space-x-10">
                <div>
                  ...
                  <p><GiRotaryPhone className="inline mr-2" /><a href="tel:+94812052230">081-20 52 230</a></p>
                  <p><GiRotaryPhone className="inline mr-2" /><a href="tel:+94812052224">081-20 52 224</a></p>
                </div>
                <div>
                  <p><FaLocationDot className="inline mr-2" />Kandy</p>
                  <p><GiRotaryPhone className="inline mr-2" /><a href="tel:+94812222494">081-22 22 494</a></p>
                </div>
              </div>
            </div>
          </div>
